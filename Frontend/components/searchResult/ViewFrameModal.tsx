            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <MetaDataRow label="Video name" value={frame.video_name} />
                    <MetaDataRow label="Frame ID" value={frame.frame_id} />
                    <MetaDataRow label="Frame name" value={frame.frame_name} />
                    {isQA && (
                      <MetaDataRow
                        label="Answer"
                        value={activeQuery?.answers[frame.frame_id]}
                      />
                    )}
                  </Box>
